...
export const TEST_SIGN_CLIENT_OPTIONS = {
  logger: "debug",
...
export const TEST_SIGN_CLIENT_OPTIONS_USAs = {
  logger: "fatal",
...
export const TEST_SIGN_CLIENT_OPTIONS_EU = {
  logger: "fatal",
...
export const TEST_SIGN_CLIENT_OPTIONS_AP = {
  logger: "fatal",
...
export const TEST_APP_METADATA_B = {
