...
class WCApp{
    constructor(settings)
    {
        ...
        success =this.serviceManager.registerService(new StarkExGateway(this.serviceManager,undefined));    
        if (success == false)
            throw new Error('!Could not add Stark Gateway'); 
    }
    ...
    async listen(){
        // This is a developer example of how to receive a message from the wallet. However, in this POC project the wallet does not send any messages.
        // We reccomend leaving this in as an instructive STUB for future developers to extend if they choose.
